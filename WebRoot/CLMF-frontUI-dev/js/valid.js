	...
	var init = {
		...
		initHtml : function(check_text,class_text,el){
			...
			var box = el.getBoundingClientRect(),
				...
				top = box.top + (self.pageYOffset || htmll.scrollTop || body.scrollTop ) - clientTop - 140,
			...
			html += '		border-color: rgba(51, 153, 204,0.7) transparent transparent transparent; left: 2px; top: 33px;">';
			html += '</span></span>';
			return html;
		},
		_blur : function(){
