...
public class CiperUtil {
	private static final Logger log = Logger.getLogger(CiperUtil.class);
	...
	public static String encrypt(String data) {
		return encrypt(SECURITY_KEY, data);
	}
	...
	public static String decrypt(String data) {
		...
		return new String(
				decrypt(aa, AsciiUtil.ascii2Hex(SECURITY_KEY.getBytes()),
						DES_ECB_ALGORITHM));
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("加密后:" + CiperUtil.encrypt(orign));
		System.out
				.println("解密后:" + CiperUtil.decrypt(CiperUtil.encrypt(orign)));
