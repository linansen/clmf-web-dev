...
<html lang="en">
	...
	<body>
		...
		<div class="row-body">
			...
			<div class="col-lg-12">
				<form id="form" action="${contextPath}/guestFile/uploadFile" method="post" enctype="multipart/form-data">
				<!-- page -->
				...
				<div class="panel panel-primary">
					...
					<div class="panel-heading">
							...
							<p class="text-capitalize">
								<span class="fa fa-info-circle fa-2x"></span>&nbsp;嘉宾资料
		...
		<script type="text/javascript">
			...
			function donwload(id){
				window.location.href = getProjectName()+"/guestFile/download/"+id;
			}
			function deleteFile(id){
				window.location.href = getProjectName()+"/guestFile/deleteFile/"+id;
			}
			...
			function batchDelete(){
				...
				window.location.href = getProjectName()+"/guestFile/batchDelete/"+fileIdArrStr;
			}
