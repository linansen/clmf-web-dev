    ...
    i = {
        ...
        appendNodes: function(b, a, c, d, f, g) {
            ...
            for (var e = [], j = b.data.key.children, k = 0, m = c.length; k < m; k++) {
                ...
                g && (i.makeDOMNodeMainBefore(e, b, n), i.makeDOMNodeLine(e, b, n), h.getBeforeA(b, n, e), i.makeDOMNodeNameBefore(e, b, n), h.getInnerBeforeA(b, n, e), i.makeDOMNodeIcon(e, b, n), h.getInnerAfterA(b, n, e), i.makeDOMNodeNameAfter(e, b, n), h.getAfterA(b, n, e), n.isParent && n.open && i.makeUlHtml(b, n, e, t.join("")), i.makeDOMNodeMainAfter(e, b, n), h.addCreatedNode(b, n))
            }
            return e
        },
        ...
        removeNode: function(b, a) {
            ...
            if (h.getNodeCache(b, a.tId)) {
                ...
                g.css("display", "none");
                    ...
                    l = k(o, e.id.SWITCH, b);
                    j = k(o, e.id.ICON, b);
                    f == c ? f[d].length == 1 ? i.replaceSwitchClass(o, l, e.line.ROOT) : (c = k(f[d][0], e.id.SWITCH, b), i.replaceSwitchClass(f[d][0], c, e.line.ROOTS), i.replaceSwitchClass(o, l, e.line.BOTTOM)) : i.replaceSwitchClass(o, l, e.line.BOTTOM);
